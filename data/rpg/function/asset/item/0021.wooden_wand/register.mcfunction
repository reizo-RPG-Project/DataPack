#> rpg:asset/item/0021.wooden_wand/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"木杖"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"魔木とトウヒの混合板材で作られた杖",color:"gray",italic:0b},{"text":"威力こそ弱いが扱いやすい。",color:"gray",italic:0b}]
