...
# 初期データ追加
    execute if data storage ui: DEF.head run data modify storage ui: DEF.data append value [{"text":"\uF80A",font:"space"},{"text":"0",font:"icon/armor/head/_"},{storage:"ui:",nbt:"DEF.head",font:"icon/armor/head/num",color:"white"}]
