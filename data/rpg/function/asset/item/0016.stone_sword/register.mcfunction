#> rpg:asset/item/0016.stone_sword/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"石の剣"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"強き 意思 を感じる...ﾂｸﾃｰﾝ",color:"gray",italic:0b}]
...
# フィールド
    ...
    # 物理攻撃力
    data modify storage reizo_mcfunc_engin:item Field.STR set value 14
    # 攻撃速度
